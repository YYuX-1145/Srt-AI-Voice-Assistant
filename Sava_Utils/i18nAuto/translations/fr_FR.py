i18n_dict = {
    ...
    "Requires a restart": "Un redémarrage requis",
    ...
    "Enable LAN access.": "Activer l'accès au réseau local.",
    ...
    "Edit Panel Row Count": "Nombre de lignes de la barre d'édition",
    ...
    "Downgrade GPT-SoVITS API version to v1": "Utiliser l'api_v1 au lieu de l'api_v2",
    "Python Interpreter Path for GPT-SoVITS": "Chemin de l'interpréteur Python pour GSV",
    "Root Path of GPT-SoVITS": "Répertoire racine du projet GSV",
    "Server Region": "Région de service",
    "API=KEY Warning: Key is stored in plaintext. DO NOT send the key to others or share your configuration file!": "Clé  Warning: La clé est stockée en texte brut. Ne transmettez pas la clé à d'autres personnes ou ne partagez pas votre fichier de configuration !",
    ...
    "(ms)Minimum slice interval": "(ms)Intervalle de découpe minimal",
    "(ms)Maximum silence length": "(ms)Longueur minimale du silence après la découpe",
